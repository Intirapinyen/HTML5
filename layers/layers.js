...
lyr_BingAerial_0.setVisible(true);lyr_GoogleSatelliteHybrid_1.setVisible(true);lyr_OSMStandard_2.setVisible(true);lyr_amphoe_3.setVisible(true);lyr_water_way_4.setVisible(true);lyr_village_5.setVisible(true);
var layersList = [lyr_BingAerial_0,lyr_GoogleSatelliteHybrid_1,lyr_OSMStandard_2,lyr_amphoe_3,lyr_water_way_4,lyr_village_5];
...
lyr_village_5.set('fieldImages', {'NRD_CODE': '', 'VILL_CODE': '', 'VILL_NAM_T': '', 'PROV_CODE': '', });
